...
export class NuevoRegistroComponent implements OnInit {
  ...
  private initForm(){
    this.registerForm = this.formBuilder.group({
      ...
      /*-- Campos para seción Origen Llamada  -- */
      Canal: ['', Validators.required],
      CSQ: ['', Validators.required],
      TelefonoCorreo: ['', Validators.required],
      Interesa: ['',Validators.required],
      ...
      /*-- Campos para sección de Cita -- */
      CampusCita: ['', Validators.required],
      FechaCita: [{value: '', disabled: true}, Validators.required],
      Asesor: ['', Validators.required],
      HoraCita: ['', Validators.required],
      Programacion: [''],
      Transferencia: [''],
      /*-- Campos para sección de Tipificacion -- */
