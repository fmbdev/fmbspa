...
export class CreateContacComponent {
  ...
  equiFormControl = new FormControl('', [Validators.required]);
  horaFormControl= new FormControl('', [Validators.required]);
  campus2FormControl = new FormControl('', [Validators.required]);
  ...
  cicloFormControl = new FormControl('', [Validators.required]);
  ...
  celularFormControl  = new FormControl('', [Validators.required, Validators.minLength(10)]);
  telefonoFormControl  = new FormControl('', [Validators.required, Validators.minLength(10)]);
  generoFormControl  = new FormControl('', [Validators.required]);
  canalPreferidoFormControl  = new FormControl('', [Validators.required]);
  myDatepickerFormControl  = new FormControl('', [Validators.required]);  
  myDatepicker2FormControl  = new FormControl('', [Validators.required]);  
  edadFormControl  = new FormControl('', [Validators.required, numeroNameValidator()]);
