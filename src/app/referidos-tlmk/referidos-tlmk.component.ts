...
@Component({
  selector: 'app-referidos-tlmk',
  templateUrl: './referidos-tlmk.component.html',
  styleUrls: ['./referidos-tlmk.component.scss']
})

export class ReferidosTlmkComponent implements OnInit {
