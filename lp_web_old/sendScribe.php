...
function enviar_datos(){
  ...
  $service_url = 'https://endpoint.scribesoft.com/v1/orgs/27038/requests/6163?accesstoken=8d0e3e43-a352-409a-bbee-401e2ee99b9f'; 
  ...
  $data = array(
        ...
        'NumeroCelular' => htmlspecialchars($_POST['celular']),
        'TelefonoCelularPredictivo' => htmlspecialchars($_POST['telefonopredictivo']),
        'TelefonoCelularPredictivo2' => htmlspecialchars($_POST['telefonopredictivo2']),
